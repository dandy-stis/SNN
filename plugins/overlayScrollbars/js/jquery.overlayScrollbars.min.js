...
! function (t, r) {
        ...
        Tt = (o = {}, f = {}, {
            ...
            v: function (n, t, r) {
                var e = 0,
                    i = o[n];
                if (!o[gi.hOP](n)) {
                    for (i = gt[n]; e < a[gi.l]; e++) i = i || gt[(t ? a[e] : a[e].toLowerCase()) + l(n)];
                    o[n] = i
                }
                return i || r
            }
    ...
    var i, u, yi, s, v, R, L, d, h, p, b, g, m, y, wi, xi = Math,
        ...
        w = (y = [], R = mi.type, g = {
            ...
            d: (m = function (i) {
                var o = function (n) {
                    var t, r, e;
                    for (t in n) n[gi.hOP](t) && (r = n[t], (e = R(r)) == xt ? n[t] = r[i ? 1 : 0] : e == yt && (n[t] = o(r)));
                    return n
                };
    ...
    function S(r) {
        var c, e = Si.inArray,
            ...
            m = function () {
                if (0 < d[v] && p) {
                    ...
                    if (b < u) {
                        g = a - u % b, n = 33;
                        for (var f = 0; f < d[v]; f++)(t = d[f]) !== bi && (e = (r = t.options())[s], i = xi.max(1, r.autoUpdateInterval), o = l(), (!0 === e || null === e) && o - h[f] > i && (t.update("auto"), h[f] = new Date(o += i)), n = xi.max(1, xi.min(n, i)));
                        b = n
                    }
                } else b = 33
            };
        this.add = function (n) {
            ...
            var t = e(n, d); - 1 < t && (h.splice(t, 1), d.splice(t, 1), 0 === d[v] && p && (p = !1, r.autoUpdateLoop = p, c !== bi && (mi.cAF()(c), c = -1)))
        }
    }
    ...
    function z(r, n, t, kt, Ot) {
        ...
        if (lt(r)) {
            ...
            return Ct.sleep = function () {
                ...
                if (!Mt) {
                    for (var n in Ot.remove(Ct), Ge(), $e(rr), $e(tr), Fn) Ct.removeExt(n);
                    for (; 0 < Vn[gi.l];) Vn.pop()();
                    Je(!0), ur && ht(ur), ar && ht(ar), Pt && ht(tr), at(!0), ft(!0), it(!0);
                    for (var t = 0; t < Pn[gi.l]; t++) Si(Pn[t]).off("load", nt);
                ...
                function B(n) {
                    var t, r, e = [],
                        i = [pe, be, ge, me];
                    for (c = 0; c < n[H] && c !== i[H]; c++) t = n[c], (r = cn(t)) == St ? e.push(t ? ci(p.css(ve + i[c])) : 0) : e.push(r == zt ? t : 0);
                    return e
                }
                if (I || M) {
                ...
                if (cn(n) == _t) {
                    if (Fn[gi.hOP](n))
                        for (t = di({}, Fn[n]); e < r.length; e++) delete t[r[e]]
                } else
                    for (e in t = {}, Fn) t[e] = di({}, Ct.ext(e));
                return t
        ...
        function Xn(n, t, r, e, i) {
            var o = cn(t) == xt && cn(r) == xt,
                ...
                c = 0;
            if (o)
                for (; c < t[gi.l]; c++) Xn(n, t[c], r[c], e);
            else
                for (; c < f[gi.l]; c++) m ? n[0][a](f[c], r, {
                    passive: i || !1
                }) : n[u](f[c], r)
        }
        ...
        function $e(n, t) {
            if (n) {
                ...
                if (t) {
                    if (A)((O = n.addClass("observed").append(si(_n)).contents()[0])[Z] = new r(a)).observe(O);
                    else if (9 < D || !Rt) {
                        n.prepend(si(_n, si({
                            c: Sn,
                            dir: "ltr"
                        ...
                        var S = H.attachEvent,
                            z = D !== bi;
                        if (S) n.prepend(si(_n)), pt(n, W + _n)[0].attachEvent("onresize", a);
                        else {
        ...
        function ni(n) {
            ...
            if (u && (Qt = setTimeout(ni, Ye)), !(Mt || u || Kt && !a || It && !o && (t = nr.is(":hidden")) || "inline" === nr.css("display"))) {
                ...
                if (te = "n" === h, re = "s" === h, ee = "m" === h, ie = "l" === h, ne = l.autoHideDelay, Br = qr, oe = "n" === _, ae = "b" === _, ue = "h" === _, fe = "v" === _, Ur = Gt.normalizeRTL, H = H && At.x && At.y, Mr = v, Er = h, jr = b, Fr = m, qr = w, Pr = _, Ar = z, Hr = k, Ir = C, Wr = H, Dr = R, Rr = di({}, W), Kr = I, $r = E, yr = yr || {
                    ...
                    if (C)
                        if (ur ? ur.show() : (ur = Si(si(je)), er.before(ur)), Pt) tr.show();
                        else {
                    ...
                    if (or.css(pn), Et && i) {
                        var ut = function Tt() {
                            ...
                            var t, r, e = Zt.val(),
                                ...
                                l = u[gi.l],
                                s = u[u[gi.l] - 1][gi.l];
                            for (r = 0; r < o[gi.l]; r++) t = o[r][gi.l], c < t && (f = r + 1, c = t);
                            return {
                                K: l,
                                G: s,
                                J: a,
        ...
        function ri(n, t) {
            if (clearTimeout(O), n) pi(f, Rn), pi(p, Rn);
            else {
                var r, e = function () {
        ...
        function ii(n, t) {
            ...
            u.R = g, u.H = s, u.N = w, sn ? (r = o ? -(h - d - x) : x, e = n ? f + r + "px, 0)" : f + "0, " + r + "px)", b[c] = e, I && (b[l] = i && 1 < xi.abs(x - u.L) ? function S(n) {
                ...
                for (var e, i, o, a = "\\s*(([^,(]+(\\(.+?\\))?)+)[\\s,]*", u = new RegExp(a), f = new RegExp("^(" + a + ")+$"), c = "property duration timing-function delay".split(" "), l = [], s = 0, v = function (n) {
                        ...
                        for (; n.match(u);) e.push(RegExp.$1), n = n.replace(u, ze);
                        return e
                    }; s < c[gi.l]; s++)
                    for (i = v(n.css(t + "-" + c[s])), o = 0; o < i[gi.l]; o++) l[o] = (l[o] ? l[o] + Ce : ze) + i[o];
                return l.join(", ")
